...
[1.0.2]: https://github.com/smol-ninja/llmfood/releases/tag/v1.0.2
...
- Extract GitHub URLs from JSX `children`, `src`, `srcUrl`, and `source` attributes
- Resolve `${props.x}` expressions in inlined MDX snippets using caller prop values
